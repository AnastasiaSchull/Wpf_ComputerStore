    ...
    class DBContext : DbContext
    {
            ...
            : base(_options)
        {
            if (Database.EnsureCreated())
            {
                ...
                ComputerDetails.Add(cd1);
                ComputerDetails.Add(cd2);
                ComputerDetails.Add(cd3);
                ComputerDetails.Add(cd4);
                ComputerDetails.Add(cd5);
                ComputerDetails.Add(cd6);
                ComputerDetails.Add(cd7);
                ComputerDetails.Add(cd8);
                ComputerDetails.Add(cd9);
                ComputerDetails.Add(cd10);
                ComputerDetails.Add(cd11);
                ComputerDetails.Add(cd12);
                ComputerDetails.Add(cd13);
                ComputerDetails.Add(cd14);
